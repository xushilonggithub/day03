...
<body class="gray-bg">
        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="text" name="contenttile" class="form-control" id="txt_search_contenttile" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>广告链接：</td>
								<td><input type="text" id="contenurl" name="contenurl"
									class="form-control" aria-required="true" required/></td>
							</tr>
							<tr>
								<td>广告分类：</td>
							...
							<tr>
								...
								<td colspan="4">
									<select class="form-control" name="status" id = "status" aria-required="true" required>
										...
										<option value="启用">---请启用---</option>
										
										<option value="禁用">---请禁用---</option>
	...
	<div class="modal fade" id="modal_user_import" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_import" method="post" action="importContent.htm" enctype="multipart/form-date">
					
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>请选择导入文件：</td>
								<td><input type="file" id="contentFile" name="contentFile"
									class="form-control" aria-required="true" required/></td>
							</tr>
	...
	var TableInit = function () {
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            contenttile: $("#txt_search_contenttile").val(),
	...
	function initEditUser(getSelection){
		...
		$('#contenurl').val(getSelection.contenurl);
